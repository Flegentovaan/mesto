...
const popupInputName = popupTypeInfo.querySelector('.popup__input_type_name');
const popupForm = popupTypeInfo.querySelector('.popup__form');
const popupNameChange = document.querySelector('.profile__name');
const popupInputDescription = popupTypeInfo.querySelector('.popup__input_type_description');
